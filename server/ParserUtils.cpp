...
void    setup_server_names(std::string& line, ServerData& server) {
...
void    setup_routes(std::vector<std::string>   rts_vector, ServerData& server) {
    Routes  route;
...
void    fill_class(std::string server_config, std::vector<ServerData>& servers_vector) {
    std::stringstream   ss(server_config);
    std::string         line;
    ServerData              server; //
    std::string         tmp;
